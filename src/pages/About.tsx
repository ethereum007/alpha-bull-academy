...
const AboutPage = () => {
  return (
    <>
      <Helmet>
        <title>About AlphaBull | Stock Market Education Platform India</title>
        <meta name="description" content="AlphaBull is an online stock market education platform in India. Learn stock market concepts, trading strategies, and risk management through structured online courses." />
        <meta name="keywords" content="stock market education India, trading courses, learn trading, stock market training Hyderabad" />
        <link rel="canonical" href="https://alphabull.club/about" />
      </Helmet>
        ...
        <main className="pt-24 pb-16">
          <section className="py-16 bg-muted/30">
            <div className="container mx-auto px-4">
              ...
              >
                <h1 className="text-4xl md:text-5xl font-bold mb-6 font-heading">About AlphaBull</h1>
              ...
              >
                <Card className="p-8">
                  <h2 className="text-2xl font-bold mb-4 font-heading">Meet Your Instructor</h2>
